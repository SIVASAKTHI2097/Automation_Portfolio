...
function ContactSection() {
  ...
  return (
    <section className="section contact-section" id="contact">
      <div className="section-heading assemble-top">
        <div className="projects-showcase-top-pill">
          <span>Contact</span>
        </div>

        <h2 className="section-title split-heading assemble-heading">
      ...
      <div className="contact-panel">
        {/* LEFT SIDE */}
        <div className="contact-left assemble-left">
        ...
        {/* RIGHT SIDE */}
        <div className="contact-right assemble-right">
